...
2. [Evidence ontology and exclusions](ontology-and-exclusions.md) — truth states, source labels, privacy and hard exclusions.
3. [Movement anomaly model card](model-card.md) — detector choice, chronological benchmark and limitations.
4. [Four-minute demo](demo-script.md) — the operator story from Live to Replay and Signal Review.
